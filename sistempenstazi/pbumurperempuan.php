...
$jumlahdata = count(query("SELECT * FROM pbu_perempuan"));
$jumlahhalaman = ceil($jumlahdata / $jumlahdataperhalaman);
$halamanaktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awaldata = ( $jumlahdataperhalaman * $halamanaktif ) - $jumlahdataperhalaman;

$bbuperempuan = query("SELECT * FROM pbu_perempuan LIMIT $awaldata, $jumlahdataperhalaman");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Standar Tinggi Badan menurut Umur (PB/U) Anak Perempuan Umur 0-24</h1>
