...
$jumlahdata = count(query("SELECT * FROM bbu_lakilaki"));
$jumlahhalaman = ceil($jumlahdata / $jumlahdataperhalaman);
$halamanaktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awaldata = ( $jumlahdataperhalaman * $halamanaktif ) - $jumlahdataperhalaman;

$bbulakilaki = query("SELECT * FROM bbu_lakilaki LIMIT $awaldata, $jumlahdataperhalaman");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Tabel Standar Berat Badan Menurut Umur (BB/U) Untuk Anak Laki-Laki Umur 0 – 60 Bulan</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        <?php foreach( $bbulakilaki as $row ) : ?>
                                        <tr>
