...
$jumlahdata = count(query("SELECT * FROM orang_tua"));
$jumlahhalaman = ceil($jumlahdata / $jumlahdataperhalaman);
$halamanaktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awaldata = ( $jumlahdataperhalaman * $halamanaktif ) - $jumlahdataperhalaman;

$orangtua = query("SELECT * FROM orang_tua LIMIT $awaldata, $jumlahdataperhalaman");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tabel Data Orang Tua</h1>
                        <a href="exportorangtua.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="tambahorangtua.php" class="btn btn-primary">Tambah Data</a>
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" 
                            action="" method="post">
                            <div class="input-group">
                            <input type="text" name="keyword" class="form-control bg-light border-0 small" placeholder="Cari Data Orang Tua..." 
                                autofocus autocomplete="off">
                            <div class="input-group-append">
                                <button class="btn btn-primary" name="cariorangtua" type="submit">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row["nik_orangtua"]; ?></td>
                                            <td><?= $row["tempat_lahir"]; ?></td>
                                            <td><?= $row["tanggal_lahir"]; ?></td>
                                            <td><?= $row["golongan_darah"]; ?></td>
                                            <td><?= $row["jenis_kelamin"]; ?></td>
                                            <td><?= $row["jenis_pelayanan"]; ?></td>
                                            <td><?= $row["fasilitas_pelayanan_kesehatan"]; ?></td>
                                            <td><?= $row["pendidikan"]; ?></td>
                                            <td><?= $row["pekerjaan"]; ?></td>
                                            <td><?= $row["alamat"]; ?></td>
                                            <td><?= $row["telepon"]; ?></td>
                                            <td><?= $row["status_orangtua"]; ?></td>
                                            <td>
                                                <a href="editorangtua.php?id=<?= $row["id_orangtua"]; ?>" class="btn btn-warning">Edit</a>
                                                    <br>
                                                    <br>
                                                <a href="hapusorangtua.php?id=<?= $row["id_orangtua"]; ?>" class="btn btn-danger" 
