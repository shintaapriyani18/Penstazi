            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tabel Data Balita</h1>
                        <a href="exportbalita.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="tambahbalita.php" class="btn btn-primary">Tambah Data</a>
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" 
                            action="" method="post">
                            <div class="input-group">
                            <input type="text" name="keyword" class="form-control bg-light border-0 small" placeholder="Cari Data Balita..." 
                                autofocus autocomplete="off">
                            <div class="input-group-append">
                                <button class="btn btn-primary" name="caribalita" type="submit">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editbalita.php?id=<?= $row["id"]; ?>" class="btn btn-warning">Edit</a>
                                                    <br>
                                                    <br>
                                                <a href="hapusbalita.php?id=<?= $row["id"]; ?>" class="btn btn-danger" 
