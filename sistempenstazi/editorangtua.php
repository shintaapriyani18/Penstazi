...
$orang_tua = query("SELECT * FROM orang_tua WHERE 
                    id_orangtua = $id")[0];

if( isset($_POST["submit"]) ) {
   
    //cek apakah data berhasil diedit atau tidak
    if( editorangtua($_POST) > 0 ) {
        echo "
        <script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <input type="hidden" name="id_orangtua" value="<?= $orang_tua["id_orangtua"]; ?>">
                        <div class="row mb-3">
                            <label for="nama" class="col-sm-2 col-form-label">Nama</label>
                            <div class="col-sm-10">
                            <input type="text" name="nama_orangtua" class="form-control" id="nama_orangtua" 
                             value="<?= $orang_tua["nama_orangtua"]; ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="text" name="golongandarah" class="form-control" id="golongandarah" required
                             value="<?= $orang_tua["golongan_darah"]; ?>">
                            </div>
                        </div>
                        <fieldset class="row mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="perempuan" 
                                 value="Perempuan" <?php if($orang_tua['jenis_kelamin']=='Perempuan') echo 'checked'?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="lakilaki" 
                                 value="Laki-laki" <?php if($orang_tua['jenis_kelamin']=='Laki-laki') echo 'checked'?>>
                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenispelayanan" id="jkn" 
                                 value="JKN" <?php if($orang_tua['jenis_pelayanan']=='JKN') echo 'checked'?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenispelayanan" id="asuransilain" 
                                 value="Asuransi Lain" <?php if($orang_tua['jenis_pelayanan']=='Asuransi Lain') echo 'checked'?>>
                            ...
                            <div class="form-check disabled">
                                <input class="form-check-input" type="radio" name="jenispelayanan" id="tidakada" 
                                 value="Tidak Ada" <?php if($orang_tua['jenis_pelayanan']=='Tidak Ada') echo 'checked'?>>
                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fasilitas" id="primer" 
                                 value="Primer" <?php if($orang_tua['fasilitas_pelayanan_kesehatan']=='Primer') echo 'checked'?>>
                            ...
                            <div class="form-check">
                                ...
                                value="Sekunder" <?php if($orang_tua['fasilitas_pelayanan_kesehatan']=='Sekunder') echo 'checked'?>>
                            ...
                            <div class="form-check disabled">
                                <input class="form-check-input" type="radio" name="fasilitas" id="tidakada" 
                                 value="Tidak Ada" <?php if($orang_tua['fasilitas_pelayanan_kesehatan']=='Tidak Ada') echo 'checked'?>>
                                <label class="form-check-label" for="tidakada">
                                Tidak Ada
                                </label>
                            </div>
                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="statusorangtua" id="ibu" 
                                 value="Ibu" <?php if($orang_tua['status_orangtua']=='Ibu') echo 'checked'?>>
                                <label class="form-check-label" for="ibu">
                                Ibu
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="statusorangtua" id="ayah" 
                                 value="Ayah" <?php if($orang_tua['status_orangtua']=='Ayah') echo 'checked'?>>
                                <label class="form-check-label" for="ayah">
                                Ayah
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="statusorangtua" id="wali" 
                                 value="Wali" <?php if($orang_tua['status_orangtua']=='Wali') echo 'checked'?>>
