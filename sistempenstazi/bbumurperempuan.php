...
$jumlahdata = count(query("SELECT * FROM bbu_perempuan"));
$jumlahhalaman = ceil($jumlahdata / $jumlahdataperhalaman);
$halamanaktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awaldata = ( $jumlahdataperhalaman * $halamanaktif ) - $jumlahdataperhalaman;

$bbuperempuan = query("SELECT * FROM bbu_perempuan LIMIT $awaldata, $jumlahdataperhalaman");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Tabel Standar Berat Badan Menurut Umur (BB/U) Untuk Anak Perempuan Umur 0 – 60 Bulan</h1>
